...
//
// Solidity: function getCampaigns() view returns((address,string,string,uint256,uint256,uint256,bool)[])
func (_CrowdFunding *CrowdFundingCaller) GetCampaigns(opts *bind.CallOpts) ([]Campaign, error) {
	var out []interface{}
...
//
// Solidity: function getCampaigns() view returns((address,string,string,uint256,uint256,uint256,bool)[])
func (_CrowdFunding *CrowdFundingSession) GetCampaigns() ([]Campaign, error) {
...
//
// Solidity: function getCampaigns() view returns((address,string,string,uint256,uint256,uint256,bool)[])
func (_CrowdFunding *CrowdFundingCallerSession) GetCampaigns() ([]Campaign, error) {
	return _CrowdFunding.Contract.GetCampaigns(&_CrowdFunding.CallOpts)
}
